				   ...
				   u8 **resp_ies, size_t *resp_ies_len)
{
	...
	*resp_ies_len = 0;
	...
	/*
	 * The public domain version of this function installs the PTK by calling
	 * wpa_ft_install_ptk(sm) here. The Quantenna FT implementation has
	 * a two-step installation, and installs the PTK upon the WPA_ASSOC_FT event.
	 */
