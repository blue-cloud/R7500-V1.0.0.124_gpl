...
qtn_macfw:
	$(call copy_fw,$(QTN_FW_STAGING)/qtn_driver*,/etc/firmware)

qtn_dspfw:
	$(call copy_fw,$(QTN_FW_STAGING)/rdsp_driver*,/etc/firmware)
...
qtn_aucfw:
	$(call copy_fw,$(QTN_FW_STAGING)/auc_driver*,/etc/firmware)
