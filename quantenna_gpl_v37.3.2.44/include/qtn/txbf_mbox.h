...
struct qtn_dsp_stats {
	...
	uint32_t dsp_act_rx_failed[DSP_ACT_RX_DBG_SIZE];
...
#define MU_PRECODING_ALGORITHM_DEFAULT	MU_ALGORITHM_AUTO
...
RUBY_INLINE struct qtn_txbf_mbox*
qtn_txbf_mbox_get(void)
{
#if defined(MUC_BUILD) || defined(DSP_BUILD) || defined(AUC_BUILD)
	return (struct qtn_txbf_mbox*)qtn_mproc_sync_nocache
...
RUBY_INLINE struct qtn_muc_dsp_mbox*
qtn_muc_dsp_mbox_get(void)
{
#if defined(MUC_BUILD) || defined(DSP_BUILD) || defined(AUC_BUILD)
	return (struct qtn_muc_dsp_mbox*)qtn_mproc_sync_nocache
