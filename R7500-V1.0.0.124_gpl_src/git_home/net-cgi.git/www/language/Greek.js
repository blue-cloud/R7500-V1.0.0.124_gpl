...
wait_upg_head="Βοηθός αναβάθμισης υλικολογισμικού"
cancel_mark="Άκυρο"
wizard_pls_wait="Περιμένετε λίγο..."
wait_new_version="Βρέθηκε νέα έκδοση υλικολογισμικού. Επιθυμείτε αναβάθμιση στη νέα έκδοση τώρα;"
current_firmware="Τρέχουσα έκδοση"
new_firmware="New Version"
current_language="Τρέχουσα έκδοση γλώσσας GUI"
new_language="Νέα έκδοση γλώσσας GUI"
greendl_upgrade_version_cur="Τρέχουσα έκδοση NETGEAR Downloader"
greendl_upgrade_version_new="Νέα έκδοση NETGEAR Downloader"
yes_mark="Ναι"
no_mark="Όχι"
downloading_ver="Ο δρομολογητής εκτελεί λήψη της νέας έκδοσης τώρα. Περιμένετε..."
...
pro4="\%></TD></TR></TABLE>"
failure_head="Αποτυχία"
download_confile_fail="Δεν ήταν δυνατή η λήψη του υλικολογισμικού από το διακομιστή NETGEAR. Ελέγξτε τη σύνδεσή σας στο Internet."
few_second="Αυτή η οθόνη θα επιστρέψει αυτόματα στην προηγούμενη οθόνη σε λίγα δευτερόλεπτα..."
quit_mark="Έξοδος"
firmware_check="Έλεγχος έκδοσης υλικολογισμικού "
no_new_version="Δεν υπάρχει διαθέσιμη νέα έκδοση υλικολογισμικού."
...
install_netgear="Λήψη των ακόλουθων εφαρμογών δρομολογητή:"
mac_genie="NETGEAR Mac genie για υπολογιστή"
backup_home_network="<b>εφαρμογή genie.</b> Ένας προσωπικός πίνακας εργαλείων που σας επιτρέπει να παρακολουθείτε, να χειρίζεστε και να επιδιορθώνετε το οικιακό σας δίκτυο."
genie="Desktop Genie"
win_readshare="ReadySHARE Vault για δημιουργία αντιγράφων ασφαλείας του υπολογιστή σας με λειτουργικό σύστημα Windows"
readshare_explain="Εφαρμογή ReadySHARE Vault (Μόνο για υπολογιστές με Windows). Ενεργοποιεί την αυτόματη συνεχή δημιουργία ενός αντιγράφου ασφαλείας για υπολογιστή με Windows σε μια μονάδα USB που είναι συνδεδεμένη με το δρομολογητή."
download_wait="Λήψη…"
genie_install="Εγκατάσταση της εφαρμογής genie μετά την ολοκλήρωση της λήψης."
readyshare_install="Εγκατάσταση της εφαρμογής ReadySHARE Vault μετά την ολοκλήρωση της λήψης."
genie_ready_install="Install the genie app and ReadySHARE Vault app"
after="after the download completes."
click_next_finish_genie="Κάντε κλικ στο κουμπί Επόμενο μετά την εγκατάσταση της εφαρμογής genie, για να ολοκληρώσετε τη ρύθμιση παραμέτρων του δρομολογητή."
click_next_finish_rs="Κάντε κλικ στο κουμπί Επόμενο μετά την εγκατάσταση της εφαρμογής ReadySHARE Vault, για να ολοκληρώσετε τη ρύθμιση παραμέτρων του δρομολογητή."
