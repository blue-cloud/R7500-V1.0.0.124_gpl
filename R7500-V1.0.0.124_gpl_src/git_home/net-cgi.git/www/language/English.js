...
backup_home_network="<b>genie app.</b> A personal dashboard that lets you monitor, control, and repair your home network."
genie="genie app."
win_readshare="ReadySHARE Vault app (Only for Windows computers)."
readshare_explain="<b>ReadySHARE Vault app (Only for Windows computers).</b> Enables automatic continuous backup of a Windows computer to a USB drive that’s connected to your router."
download_wait="Downloading…"
genie_install="Install the genie app after the download completes."
readyshare_install="Install the ReadySHARE Vault app after the download completes."
genie_ready_install="Install the genie app and ReadySHARE Vault app"
after="after the download completes."
click_next_finish_genie="Click the <b>Next</b> button after you install the genie app to finish configuring the router."
click_next_finish_rs="Click the <b>Next</b> button after you Install the ReadySHARE Vault app to finish configuring the router."
