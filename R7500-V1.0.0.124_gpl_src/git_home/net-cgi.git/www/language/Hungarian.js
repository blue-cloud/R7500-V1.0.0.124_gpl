...
wait_upg_head="Készülékszoftver-frissítési segéd"
cancel_mark="Mégse"
wizard_pls_wait="Kérem, várjon egy pillanatig..."
wait_new_version="Az eszköz új készülékszoftver-verziót talált. Frissíteni kíván az új verzióra?"
current_firmware="Jelenlegi verzió"
new_firmware="New Version"
current_language="A GUI nyelv jelenlegi verziója"
new_language="A GUI nyelv új verziója"
greendl_upgrade_version_cur="Jelenlegi NETGEAR Downloader verzió"
greendl_upgrade_version_new="Új NETGEAR Downloader verzió"
yes_mark="Igen"
no_mark="Nem"
downloading_ver="Az útválasztó az új verzió letöltését végzi. Kérem, várjon..."
...
pro4="\%></TD></TR></TABLE>"
failure_head="Hiba"
download_confile_fail="Nem sikerült letölteni a készülékszoftvert a NETGEAR kiszolgálójáról. Kérem, ellenőrizze az internetkapcsolatot."
few_second="A képernyő néhány másodperc múlva automatikusan az előző képernyőre vált..."
quit_mark="Kilépés"
firmware_check="Készülékszoftver-verzió ellenőrzése"
no_new_version="Nincs új készülékszoftver-verzió."
...
install_netgear="A következő router-alkalmazások letöltése:"
mac_genie="Asztali számítógép – NETGEAR Mac genie"
backup_home_network="<b>genie alkalmazás.</b> Egy személyes infófal, ahol nyomon követheti, irányíthatja és kijavíthatja otthoni hálózatát."
genie="Desktop Genie"
win_readshare="ReadySHARE Vault – a Windows számítógépen tárolt adatok biztonsági mentéséhez"
readshare_explain="ReadySHARE Vault alkalmazás (csak Windowsra). Rendszeresen automatikus biztonsági mentést készít Windowsos számítógépről az útválasztóhoz csatlakoztatott USB-s meghajtóra."
download_wait="Letöltés…"
genie_install="A genie alkalmazás letöltődése után telepítse az alkalmazást."
readyshare_install="A ReadySHARE Vault alkalmazás letöltődése után telepítse az alkalmazást."
genie_ready_install="Install the genie app and ReadySHARE Vault app"
after="after the download completes."
click_next_finish_genie="A genie alkalmazás telepítése után kattintson a Tovább gombra az útválasztó beállításainak véglegesítéséhez."
click_next_finish_rs="A ReadySHARE Vault alkalmazás telepítése után kattintson a Tovább gombra az útválasztó beállításainak véglegesítéséhez."
