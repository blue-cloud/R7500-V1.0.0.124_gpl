	...
	for ( i = 0; i < tmp_array.length; i++ )
	{
		if ( tmp_array[i].indexOf("(DFS)") > -1 )
		{
			if ( 0 == hidden_dfs_channel && ( 1 == dfs_channel_router_flag ||
				...
				( dfs_channel3_router_flag == 1 && ((index == 6 && top.is_jp_version == 1) || index == 10)) ) ) //Japan, United States
			{
...
var ht40_array = new Array(
	...
	new Array ( "36", "40", "44", "48", "52(DFS)", "56(DFS)", "60(DFS)", "64(DFS)", "100(DFS)", "104(DFS)", "108(DFS)", "112(DFS)", "116(DFS)", "120(DFS)", "124(DFS)", "128(DFS)", "132(DFS)", "136(DFS)", "149", "153", "157", "161" ), //10
